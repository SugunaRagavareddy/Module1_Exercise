...
public class TC_05_SauceLabDemo {
	...
	public void VerifyApplication() throws InterruptedException{
	    ...
	    if(buttontext.matches("uppercase"))
	        System.out.println("Button text is all capitalized");
	    else
	        System.out.println("Button text is not in calpital letter");
	    ...
	    if(defaultActualvalue.equalsIgnoreCase(expectedActualvalue))
			System.out.println("Default Dropdown value Matched correctly");
		else
			System.out.println("Default Dropdown value did not match correctly");	    
	    Thread.sleep(2000);
	    ...
	    if(CartValue.getText().equals("1"))
	        System.out.println("Cart has 1 item only");
	    else
	        System.out.println("Cart value is not 1 item");
